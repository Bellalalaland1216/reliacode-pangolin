const CHINA_REGIONS = Object.freeze({
  ...
  '香港特别行政区':['香港岛','九龙','新界'],'澳门特别行政区':['澳门半岛','氹仔','路环'],'台湾省':['台北市','新北市','桃园市','台中市','台南市','高雄市','基隆市','新竹市','嘉义市','其他县市']
});
...
function normalizeRegionSelection(country, province, city) {
  ...
  if (normalizedCountry !== '中国' || !Object.hasOwn(CHINA_REGIONS, normalizedProvince) || !CHINA_REGIONS[normalizedProvince].includes(normalizedCity)) return null;
  return { country: normalizedCountry, province: normalizedProvince, city: normalizedCity, region: `${normalizedProvince}${normalizedCity}` };
}
